...
class BarangayController extends Controller
{
    ...
    {
        return view('abc.barangays.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('abc.barangays.index')
    ...
    public function show(Barangay $barangay)
    {
        ...
        return view('abc.barangays.show', compact('barangay', 'stats'));
    }

    public function edit(Barangay $barangay)
    {
        return view('abc.barangays.edit', compact('barangay'));
    }
    ...
    public function update(Request $request, Barangay $barangay)
    {
        ...
        return redirect()->route('abc.barangays.show', $barangay)
