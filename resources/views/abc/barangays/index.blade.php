...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('abc.barangays.create') }}" class="btn btn-primary">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('abc.barangays.index') }}">
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('abc.barangays.index') }}" class="btn btn-outline-secondary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group-vertical btn-group-sm" role="group">
                                        <a href="{{ route('abc.barangays.show', $barangay) }}" 
                                           class="btn btn-sm btn-outline-info" title="View Details">
                                            <i class="fas fa-eye"></i> View
                                        </a>
                                        <a href="{{ route('abc.barangays.edit', $barangay) }}" 
