    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('abc.profile.update') }}" method="POST">
                        @csrf
                        @method('PUT')
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('abc.profile.password') }}" method="POST">
                        @csrf
...
<div class="modal fade" id="photoModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('abc.profile.photo') }}" method="POST" enctype="multipart/form-data">
                @csrf
