...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.barangays.index') }}">Barangays</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.barangays.show', $barangay) }}">{{ $barangay->name }}</a></li>
        ...
        <div>
            <a href="{{ route('admin.barangays.show', $barangay) }}" class="btn btn-secondary">
                <i class="fas fa-eye"></i> View Details
            </a>
            <a href="{{ route('admin.barangays.index') }}" class="btn btn-outline-secondary ml-2">
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.barangays.update', $barangay) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-0">
                            ...
                            <a href="{{ route('admin.barangays.show', $barangay) }}" class="btn btn-secondary ml-2">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{ route('admin.barangays.destroy', $barangay) }}" style="display: inline-block;">
                    @csrf
                    @method('DELETE')
