...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('admin.barangays.edit', $barangay) }}" class="btn btn-primary">
                <i class="fas fa-edit"></i> Edit Barangay
            </a>
            <a href="{{ route('admin.barangays.index') }}" class="btn btn-secondary ml-2">
        ...
        <div class="col-xl-8">
            ...
            <div class="card shadow">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.users.index', ['barangay' => $barangay->id]) }}" class="btn btn-sm btn-outline-primary">
                        View All
                    </a>
                </div>
                <div class="card-body">
                    ...
                    @else
                        <div class="text-center py-4">
                            ...
                            <a href="{{ route('admin.users.create', ['barangay' => $barangay->id]) }}" class="btn btn-primary btn-sm">
