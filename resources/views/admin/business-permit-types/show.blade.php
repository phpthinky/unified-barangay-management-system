...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <p class="mb-0">
                                <span class="badge bg-info">{{ ucwords(str_replace('_', ' ', $businessPermitType->category)) }}</span>
                            </p>
                        </div>
                        <div class="col-md-3 mb-3">
            ...
            <!-- Requirements -->
            @if($businessPermitType->requirements && count($businessPermitType->requirements) > 0)
            <div class="card shadow mb-4">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.business-permits.show', $permit) }}" class="btn btn-sm btn-info">
        ...
        <div class="col-lg-4">
            ...
            <!-- Template Fields -->
            @if($businessPermitType->template_fields && count($businessPermitType->template_fields) > 0)
            <div class="card shadow mb-4">
