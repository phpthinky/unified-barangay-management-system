    ...
    <div class="card-body">
        <form action="{{ route('admin.complaint-types.store') }}" method="POST">
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('category') is-invalid @enderror" 
                            ...
                            <option value="barangay" {{ old('category') == 'barangay' ? 'selected' : '' }}>Barangay</option>
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control @error('default_handler_type') is-invalid @enderror" 
                            ...
                            <option value="captain" {{ old('default_handler_type') == 'captain' ? 'selected' : '' }}>Barangay Captain</option>
                            <option value="secretary" {{ old('default_handler_type') == 'secretary' ? 'selected' : '' }}>Barangay Secretary</option>
                            <option value="lupon" {{ old('default_handler_type') == 'lupon' ? 'selected' : '' }}>Lupon Member</option>
                            <option value="any_staff" {{ old('default_handler_type') == 'any_staff' ? 'selected' : '' }}>Any Barangay Staff</option>
                        </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('estimated_resolution_days') is-invalid @enderror" 
                               ...
                               value="{{ old('estimated_resolution_days', 15) }}" min="1" max="365" required>
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input" id="requires_hearing" 
                                   name="requires_hearing" value="1" {{ old('requires_hearing') ? 'checked' : '' }}>
            ...
            <div class="row mt-4">
                <div class="col-12">
                    ...
                    <div id="required-information-container">
                        @if(old('required_information'))
                            @foreach(old('required_information') as $index => $info)
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-4">
                <a href="{{ route('admin.complaint-types.index') }}" class="btn btn-secondary me-md-2">Cancel</a>
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Create Complaint Type
                </button>
            </div>
        </form>
    </div>
