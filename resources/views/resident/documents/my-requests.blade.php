{{-- FILE: resources/views/resident/documents/my-requests.blade.php --}}
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="{{ route('resident.documents.index') }}" class="btn btn-primary">
    ...
    <div class="card-body">
        ...
        <form method="GET" class="row g-3 mb-4">
            ...
            <div class="col-md-3">
                ...
                <a href="{{ route('resident.documents.my-requests') }}" class="btn btn-outline-secondary">Clear</a>
            </div>
        </form>
